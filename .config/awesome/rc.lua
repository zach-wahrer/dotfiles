...
globalkeys = gears.table.join(
	...
	awful.key({ modkey }, "e", function()
		awful.util.spawn("sh /home/zach/scripts/pe.sh")
	end, { description = "launch code editor", group = "launcher" }),

	-- Audio
	awful.key({ "Control" }, "1", function()
		awful.util.spawn("sh /home/zach/scripts/headset_audio.sh")
	end, { description = "switch to headset", group = "launcher" }),
	awful.key({ "Control" }, "2", function()
		awful.util.spawn("sh /home/zach/scripts/laptop_audio.sh")
	end, { description = "switch to laptop", group = "launcher" }),
