...
if [[ $outputs == "eDP-1" ]]; then
	...
	xrandr --output eDP-1 --mode 1920x1200 --pos 0x1080 --rotate normal --output DP-1 --off --output DP-2 --off --output DP-3 --off --output DP-2-1 --primary --mode 1920x1080 --pos 0x0 --rotate normal --output DP-2-2 --mode 1920x1080 --pos 1920x499 --rotate normal --output DP-2-3 --off
fi
