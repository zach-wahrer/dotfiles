...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'null-ls.nvim', 'undofile_warn.vim', 'dial.nvim', 'neodim', 'tabout.nvim', 'YankAssassin.vim', 'nvim-dap-virtual-text', 'spelunker.vim', 'spellsitter.nvim', 'registers.nvim', 'neogen', 'nvim-lint', 'diffview.nvim', 'jester', 'nvim-dap-ui', 'vim-test', 'gitsigns.nvim', 'nvim-dap', 'git-messenger.vim', 'nvim-ts-autotag'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
