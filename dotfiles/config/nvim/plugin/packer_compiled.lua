...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'nvim-dap-virtual-text', 'nvim-ts-autotag', 'vim-dotenv', 'undofile_warn.vim', 'jester', 'tabout.nvim', 'gitsigns.nvim', 'spelunker.vim', 'git-messenger.vim', 'spellsitter.nvim', 'registers.nvim', 'dial.nvim', 'prettier.nvim', 'nvim-lint', 'diffview.nvim', 'nvim-surround', 'YankAssassin.vim', 'nvim-dap-ui', 'neodim', 'nvim-dap', 'neogen', 'vim-test', 'kommentary'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
