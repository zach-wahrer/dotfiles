...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'tabout.nvim', 'gitsigns.nvim', 'nvim-dap-virtual-text', 'git-messenger.vim', 'spelunker.vim', 'spellsitter.nvim', 'registers.nvim', 'neodim', 'nvim-ts-autotag', 'YankAssassin.vim', 'nvim-lint', 'nvim-dap-ui', 'null-ls.nvim', 'neogen', 'dial.nvim', 'undofile_warn.vim', 'vim-test', 'diffview.nvim', 'nvim-dap', 'jester'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
