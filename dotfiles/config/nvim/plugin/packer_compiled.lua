...
vim.cmd [[au FileType go ++once lua require("packer.load")({'gotests-vim', 'vim-go', 'vim-delve', 'nvim-dap-go'}, { ft = "go" }, _G.packer_plugins)]]
vim.cmd [[au FileType lua ++once lua require("packer.load")({'stylua-nvim'}, { ft = "lua" }, _G.packer_plugins)]]
time([[Defining lazy-load filetype autocommands]], false)
  -- Event lazy-loads
time([[Defining lazy-load event autocommands]], true)
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'jester', 'neodim', 'registers.nvim', 'gitsigns.nvim', 'vim-test', 'git-messenger.vim', 'prettier.nvim', 'diffview.nvim', 'dial.nvim', 'spelunker.vim', 'spellsitter.nvim', 'nvim-lint', 'YankAssassin.vim', 'neogen', 'nvim-dap-ui', 'nvim-ts-autotag', 'nvim-dap-virtual-text', 'nvim-dap', 'undofile_warn.vim', 'tabout.nvim', 'vim-dotenv'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
