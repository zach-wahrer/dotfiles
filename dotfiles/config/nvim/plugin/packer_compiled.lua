...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'nvim-lint', 'vim-test', 'nvim-dap-ui', 'nvim-dap', 'neogen', 'vim-dotenv', 'YankAssassin.vim', 'nvim-ts-autotag', 'tabout.nvim', 'spelunker.vim', 'spellsitter.nvim', 'gitsigns.nvim', 'registers.nvim', 'git-messenger.vim', 'jester', 'prettier.nvim', 'neodim', 'diffview.nvim', 'undofile_warn.vim', 'dial.nvim', 'nvim-dap-virtual-text'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
