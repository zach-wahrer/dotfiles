...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'tabout.nvim', 'YankAssassin.vim', 'spelunker.vim', 'spellsitter.nvim', 'registers.nvim', 'prettier.nvim', 'neogen', 'nvim-ts-autotag', 'nvim-dap-virtual-text', 'jester', 'gitsigns.nvim', 'vim-test', 'vim-dotenv', 'git-messenger.vim', 'neodim', 'nvim-lint', 'diffview.nvim', 'undofile_warn.vim', 'dial.nvim', 'nvim-dap', 'nvim-dap-ui'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
