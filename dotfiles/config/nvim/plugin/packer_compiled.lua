...
vim.cmd [[au FileType go ++once lua require("packer.load")({'vim-go', 'gotests-vim', 'vim-delve', 'nvim-dap-go'}, { ft = "go" }, _G.packer_plugins)]]
time([[Defining lazy-load filetype autocommands]], false)
  -- Event lazy-loads
time([[Defining lazy-load event autocommands]], true)
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'registers.nvim', 'spelunker.vim', 'prettier.nvim', 'spellsitter.nvim', 'jester', 'gitsigns.nvim', 'git-messenger.vim', 'undofile_warn.vim', 'nvim-lint', 'diffview.nvim', 'dial.nvim', 'tabout.nvim', 'neogen', 'vim-dotenv', 'nvim-dap-ui', 'YankAssassin.vim', 'neodim', 'nvim-ts-autotag', 'nvim-dap', 'nvim-dap-virtual-text', 'vim-test'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
