...
vim.cmd [[au FileType go ++once lua require("packer.load")({'gotests-nvim', 'vim-go', 'vim-delve', 'nvim-dap-go'}, { ft = "go" }, _G.packer_plugins)]]
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'null-ls.nvim', 'tabout.nvim', 'spelunker.vim', 'nvim-ts-autotag', 'nvim-surround', 'nvim-dap-virtual-text', 'kommentary', 'gitsigns.nvim', 'git-messenger.vim', 'neodim', 'prettier.nvim', 'diffview.nvim', 'dial.nvim', 'vim-test', 'spellsitter.nvim', 'neogen', 'vim-dotenv', 'YankAssassin.vim', 'nvim-dap-ui', 'undofile_warn.vim', 'jester', 'nvim-dap', 'registers.nvim'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
