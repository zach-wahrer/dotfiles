...
vim.cmd [[au FileType go ++once lua require("packer.load")({'gotests-vim', 'nvim-dap-ui', 'vim-delve', 'vim-go', 'nvim-dap-go'}, { ft = "go" }, _G.packer_plugins)]]
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'undotree', 'undofile_warn.vim', 'tabout.nvim', 'null-ls.nvim', 'spelunker.vim', 'spellsitter.nvim', 'registers.nvim', 'lualine-lsp-progress', 'lsp_signature.nvim', 'prettier.nvim', 'lsp-colors.nvim', 'kommentary', 'gitsigns.nvim', 'git-messenger.vim', 'diffview.nvim', 'dial.nvim', 'vim-test', 'nvim-ts-autotag', 'YankAssassin.vim', 'neogen', 'vim-dotenv', 'nvim-dap'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
