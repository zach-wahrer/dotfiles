...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'vim-dotenv', 'tabout.nvim', 'undofile_warn.vim', 'spelunker.vim', 'spellsitter.nvim', 'registers.nvim', 'prettier.nvim', 'jester', 'gitsigns.nvim', 'git-messenger.vim', 'neogen', 'nvim-dap', 'neodim', 'dial.nvim', 'nvim-dap-ui', 'diffview.nvim', 'nvim-dap-virtual-text', 'nvim-ts-autotag', 'YankAssassin.vim', 'nvim-lint', 'vim-test'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
