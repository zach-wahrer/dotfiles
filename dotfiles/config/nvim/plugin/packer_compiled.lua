...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'prettier.nvim', 'dial.nvim', 'YankAssassin.vim', 'nvim-ts-autotag', 'nvim-dap', 'vim-dotenv', 'undofile_warn.vim', 'vim-test', 'nvim-surround', 'neogen', 'neodim', 'spellsitter.nvim', 'registers.nvim', 'gitsigns.nvim', 'spelunker.vim', 'tabout.nvim', 'git-messenger.vim', 'null-ls.nvim', 'kommentary', 'diffview.nvim'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
