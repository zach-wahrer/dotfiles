...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'nvim-dap-virtual-text', 'neogen', 'undofile_warn.vim', 'jester', 'tabout.nvim', 'neodim', 'spelunker.vim', 'spellsitter.nvim', 'registers.nvim', 'vim-test', 'prettier.nvim', 'vim-dotenv', 'gitsigns.nvim', 'git-messenger.vim', 'dial.nvim', 'nvim-surround', 'kommentary', 'nvim-dap', 'nvim-ts-autotag', 'diffview.nvim', 'nvim-dap-ui', 'null-ls.nvim', 'YankAssassin.vim'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
