...
_G.packer_plugins = {
  ...
  neodim = {
    ...
    loaded = true,
    path = "/home/zach/.local/share/nvim/site/pack/packer/start/neodim",
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'YankAssassin.vim', 'vim-test', 'nvim-dap', 'vim-dotenv', 'null-ls.nvim', 'tabout.nvim', 'neogen', 'spellsitter.nvim', 'registers.nvim', 'gitsigns.nvim', 'git-messenger.vim', 'prettier.nvim', 'nvim-ts-autotag', 'kommentary', 'undofile_warn.vim', 'nvim-surround', 'diffview.nvim', 'dial.nvim', 'spelunker.vim'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
