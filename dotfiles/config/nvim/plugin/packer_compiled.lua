...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'nvim-dap', 'neogen', 'vim-test', 'null-ls.nvim', 'nvim-ts-autotag', 'lualine-lsp-progress', 'lsp_signature.nvim', 'vim-dotenv', 'undotree', 'undofile_warn.vim', 'git-messenger.vim', 'tabout.nvim', 'diffview.nvim', 'spelunker.vim', 'dial.nvim', 'spellsitter.nvim', 'kommentary', 'prettier.nvim', 'lsp-colors.nvim', 'registers.nvim', 'gitsigns.nvim', 'YankAssassin.vim'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
