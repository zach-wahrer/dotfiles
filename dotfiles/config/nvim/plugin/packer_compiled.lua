...
vim.cmd [[au FileType go ++once lua require("packer.load")({'nvim-dap-go', 'gotests-nvim', 'vim-delve', 'vim-go'}, { ft = "go" }, _G.packer_plugins)]]
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'nvim-dap-virtual-text', 'jester', 'nvim-lint', 'nvim-ts-autotag', 'nvim-dap-ui', 'gitsigns.nvim', 'git-messenger.vim', 'vim-dotenv', 'nvim-dap', 'neogen', 'neodim', 'tabout.nvim', 'dial.nvim', 'spellsitter.nvim', 'undofile_warn.vim', 'registers.nvim', 'YankAssassin.vim', 'diffview.nvim', 'vim-test', 'prettier.nvim', 'spelunker.vim'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
