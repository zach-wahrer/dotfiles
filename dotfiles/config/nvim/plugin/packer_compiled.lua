...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'vim-test', 'undofile_warn.vim', 'jester', 'spellsitter.nvim', 'YankAssassin.vim', 'gitsigns.nvim', 'git-messenger.vim', 'tabout.nvim', 'diffview.nvim', 'neodim', 'dial.nvim', 'nvim-lint', 'nvim-dap-ui', 'nvim-dap', 'nvim-ts-autotag', 'neogen', 'registers.nvim', 'null-ls.nvim', 'spelunker.vim', 'nvim-dap-virtual-text'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
