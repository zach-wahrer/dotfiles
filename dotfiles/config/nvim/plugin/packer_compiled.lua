...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'nvim-lint', 'vim-test', 'nvim-dap-ui', 'nvim-dap', 'vim-dotenv', 'undofile_warn.vim', 'diffview.nvim', 'tabout.nvim', 'YankAssassin.vim', 'spelunker.vim', 'spellsitter.nvim', 'registers.nvim', 'gitsigns.nvim', 'git-messenger.vim', 'neodim', 'prettier.nvim', 'nvim-ts-autotag', 'dial.nvim', 'neogen', 'nvim-dap-virtual-text', 'jester'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
