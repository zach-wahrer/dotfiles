...
vim.cmd [[au FileType go ++once lua require("packer.load")({'vim-delve', 'vim-go', 'nvim-dap-go', 'gotests-nvim'}, { ft = "go" }, _G.packer_plugins)]]
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'undofile_warn.vim', 'nvim-ts-autotag', 'diffview.nvim', 'neogen', 'tabout.nvim', 'vim-test', 'YankAssassin.vim', 'registers.nvim', 'vim-dotenv', 'neodim', 'dial.nvim', 'nvim-lint', 'jester', 'nvim-dap-ui', 'spelunker.vim', 'nvim-dap', 'gitsigns.nvim', 'prettier.nvim', 'spellsitter.nvim', 'git-messenger.vim', 'nvim-dap-virtual-text'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
