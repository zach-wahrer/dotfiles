...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'git-messenger.vim', 'undofile_warn.vim', 'diffview.nvim', 'dial.nvim', 'tabout.nvim', 'spelunker.vim', 'jester', 'spellsitter.nvim', 'registers.nvim', 'prettier.nvim', 'neodim', 'nvim-dap-virtual-text', 'gitsigns.nvim', 'kommentary', 'YankAssassin.vim', 'vim-dotenv', 'nvim-surround', 'neogen', 'nvim-lint', 'vim-test', 'nvim-ts-autotag', 'nvim-dap-ui', 'nvim-dap'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
