...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'nvim-dap-ui', 'jester', 'nvim-dap', 'nvim-ts-autotag', 'null-ls.nvim', 'vim-test', 'neodim', 'vim-dotenv', 'gitsigns.nvim', 'kommentary', 'git-messenger.vim', 'tabout.nvim', 'nvim-dap-virtual-text', 'spelunker.vim', 'undofile_warn.vim', 'diffview.nvim', 'spellsitter.nvim', 'dial.nvim', 'YankAssassin.vim', 'registers.nvim', 'nvim-surround', 'neogen', 'prettier.nvim'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
