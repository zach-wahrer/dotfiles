...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'nvim-dap-ui', 'neodim', 'nvim-surround', 'nvim-dap', 'null-ls.nvim', 'jester', 'vim-test', 'neogen', 'registers.nvim', 'git-messenger.vim', 'undofile_warn.vim', 'diffview.nvim', 'prettier.nvim', 'dial.nvim', 'nvim-dap-virtual-text', 'vim-dotenv', 'tabout.nvim', 'spellsitter.nvim', 'spelunker.vim', 'nvim-ts-autotag', 'kommentary', 'YankAssassin.vim', 'gitsigns.nvim'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
