...
vim.cmd [[au FileType go ++once lua require("packer.load")({'gotests-vim', 'nvim-dap-go', 'vim-go', 'vim-delve'}, { ft = "go" }, _G.packer_plugins)]]
time([[Defining lazy-load filetype autocommands]], false)
  -- Event lazy-loads
time([[Defining lazy-load event autocommands]], true)
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'tabout.nvim', 'spelunker.vim', 'spellsitter.nvim', 'registers.nvim', 'prettier.nvim', 'jester', 'git-messenger.vim', 'dial.nvim', 'vim-test', 'nvim-dap-ui', 'nvim-dap', 'YankAssassin.vim', 'neodim', 'undofile_warn.vim', 'neogen', 'nvim-ts-autotag', 'nvim-lint', 'gitsigns.nvim', 'diffview.nvim', 'vim-dotenv', 'nvim-dap-virtual-text'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
