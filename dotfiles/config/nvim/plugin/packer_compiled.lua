...
vim.cmd [[au FileType go ++once lua require("packer.load")({'nvim-dap-go', 'vim-go', 'gotests-vim', 'vim-delve'}, { ft = "go" }, _G.packer_plugins)]]
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'spelunker.vim', 'spellsitter.nvim', 'registers.nvim', 'nvim-ts-autotag', 'nvim-dap-ui', 'nvim-dap', 'YankAssassin.vim', 'nvim-lint', 'vim-test', 'vim-dotenv', 'jester', 'dial.nvim', 'undofile_warn.vim', 'neogen', 'gitsigns.nvim', 'git-messenger.vim', 'neodim', 'tabout.nvim', 'nvim-dap-virtual-text', 'prettier.nvim', 'diffview.nvim'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
