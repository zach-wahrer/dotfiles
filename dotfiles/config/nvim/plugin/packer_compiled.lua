...
vim.cmd [[au FileType go ++once lua require("packer.load")({'vim-go', 'gotests-vim', 'vim-delve', 'nvim-dap-ui', 'nvim-dap-go'}, { ft = "go" }, _G.packer_plugins)]]
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'null-ls.nvim', 'diffview.nvim', 'gitsigns.nvim', 'dial.nvim', 'git-messenger.vim', 'spelunker.vim', 'spellsitter.nvim', 'registers.nvim', 'prettier.nvim', 'YankAssassin.vim', 'nvim-ts-autotag', 'neogen', 'vim-dotenv', 'undofile_warn.vim', 'tabout.nvim', 'nvim-dap', 'vim-test', 'kommentary'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
