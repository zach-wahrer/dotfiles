...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'neodim', 'kommentary', 'dial.nvim', 'diffview.nvim', 'prettier.nvim', 'undofile_warn.vim', 'nvim-dap', 'vim-dotenv', 'gitsigns.nvim', 'nvim-dap-ui', 'vim-test', 'nvim-lint', 'jester', 'neogen', 'nvim-ts-autotag', 'tabout.nvim', 'spelunker.vim', 'nvim-dap-virtual-text', 'YankAssassin.vim', 'nvim-surround', 'registers.nvim', 'git-messenger.vim', 'spellsitter.nvim'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
