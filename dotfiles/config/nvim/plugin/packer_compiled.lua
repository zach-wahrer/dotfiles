...
_G.packer_plugins = {
  ...
  ["nvim-ufo"] = {
    ...
    loaded = true,
    path = "/home/zach/.local/share/nvim/site/pack/packer/start/nvim-ufo",
  ...
  ["promise-async"] = {
    loaded = true,
    path = "/home/zach/.local/share/nvim/site/pack/packer/start/promise-async",
...
vim.cmd [[au FileType go ++once lua require("packer.load")({'vim-go', 'gotests-vim', 'vim-delve', 'nvim-dap-go', 'nvim-dap-ui'}, { ft = "go" }, _G.packer_plugins)]]
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'diffview.nvim', 'spelunker.vim', 'prettier.nvim', 'registers.nvim', 'spellsitter.nvim', 'vim-test', 'tabout.nvim', 'neogen', 'lsp-colors.nvim', 'lsp_signature.nvim', 'lualine-lsp-progress', 'vim-dotenv', 'null-ls.nvim', 'nvim-ts-autotag', 'nvim-dap', 'dial.nvim', 'YankAssassin.vim', 'gitsigns.nvim', 'git-messenger.vim', 'undofile_warn.vim', 'kommentary', 'undotree'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
