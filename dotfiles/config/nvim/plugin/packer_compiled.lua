...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'lsp_signature.nvim', 'lsp-colors.nvim', 'nvim-ts-autotag', 'prettier.nvim', 'spelunker.vim', 'null-ls.nvim', 'undofile_warn.vim', 'nvim-dap', 'gitsigns.nvim', 'git-messenger.vim', 'vim-test', 'vim-dotenv', 'kommentary', 'dial.nvim', 'tabout.nvim', 'undotree', 'spellsitter.nvim', 'YankAssassin.vim', 'diffview.nvim', 'registers.nvim', 'lualine-lsp-progress', 'neogen'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
