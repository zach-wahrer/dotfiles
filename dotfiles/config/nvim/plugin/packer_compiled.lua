...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'tabout.nvim', 'spellsitter.nvim', 'nvim-dap-virtual-text', 'prettier.nvim', 'neodim', 'neogen', 'gitsigns.nvim', 'git-messenger.vim', 'nvim-ts-autotag', 'vim-test', 'diffview.nvim', 'dial.nvim', 'vim-dotenv', 'YankAssassin.vim', 'registers.nvim', 'jester', 'nvim-lint', 'undofile_warn.vim', 'spelunker.vim', 'nvim-dap-ui', 'nvim-dap'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
