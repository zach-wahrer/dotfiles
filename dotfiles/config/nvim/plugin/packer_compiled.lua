...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'registers.nvim', 'nvim-ts-autotag', 'YankAssassin.vim', 'nvim-lint', 'neogen', 'nvim-surround', 'nvim-dap', 'vim-dotenv', 'undofile_warn.vim', 'nvim-dap-virtual-text', 'jester', 'diffview.nvim', 'dial.nvim', 'gitsigns.nvim', 'git-messenger.vim', 'tabout.nvim', 'prettier.nvim', 'spelunker.vim', 'vim-test', 'kommentary', 'spellsitter.nvim', 'neodim', 'nvim-dap-ui'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
