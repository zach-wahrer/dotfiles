...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'nvim-dap', 'nvim-ts-autotag', 'vim-test', 'null-ls.nvim', 'nvim-dap-virtual-text', 'diffview.nvim', 'vim-dotenv', 'dial.nvim', 'jester', 'undofile_warn.vim', 'tabout.nvim', 'spelunker.vim', 'gitsigns.nvim', 'git-messenger.vim', 'spellsitter.nvim', 'neogen', 'registers.nvim', 'prettier.nvim', 'nvim-surround', 'neodim', 'nvim-dap-ui', 'YankAssassin.vim', 'kommentary'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
