...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'tabout.nvim', 'spelunker.vim', 'jester', 'spellsitter.nvim', 'registers.nvim', 'prettier.nvim', 'neogen', 'git-messenger.vim', 'kommentary', 'diffview.nvim', 'dial.nvim', 'nvim-dap-ui', 'nvim-dap', 'YankAssassin.vim', 'vim-test', 'nvim-dap-virtual-text', 'null-ls.nvim', 'nvim-ts-autotag', 'nvim-surround', 'vim-dotenv', 'neodim', 'undofile_warn.vim', 'gitsigns.nvim'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
