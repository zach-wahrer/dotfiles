...
vim.cmd [[au FileType go ++once lua require("packer.load")({'vim-go', 'vim-delve', 'nvim-dap-go', 'gotests-vim'}, { ft = "go" }, _G.packer_plugins)]]
vim.cmd [[au FileType lua ++once lua require("packer.load")({'stylua-nvim'}, { ft = "lua" }, _G.packer_plugins)]]
time([[Defining lazy-load filetype autocommands]], false)
  -- Event lazy-loads
time([[Defining lazy-load event autocommands]], true)
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'tabout.nvim', 'spellsitter.nvim', 'dial.nvim', 'registers.nvim', 'prettier.nvim', 'YankAssassin.vim', 'nvim-lint', 'nvim-dap', 'neogen', 'nvim-ts-autotag', 'diffview.nvim', 'nvim-dap-virtual-text', 'git-messenger.vim', 'vim-dotenv', 'spelunker.vim', 'neodim', 'undofile_warn.vim', 'jester', 'nvim-dap-ui', 'vim-test', 'gitsigns.nvim'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
