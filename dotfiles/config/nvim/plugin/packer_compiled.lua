...
vim.cmd [[au FileType go ++once lua require("packer.load")({'nvim-dap-go', 'vim-delve', 'gotests-vim', 'vim-go'}, { ft = "go" }, _G.packer_plugins)]]
vim.cmd [[au FileType lua ++once lua require("packer.load")({'stylua-nvim'}, { ft = "lua" }, _G.packer_plugins)]]
time([[Defining lazy-load filetype autocommands]], false)
  -- Event lazy-loads
time([[Defining lazy-load event autocommands]], true)
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'registers.nvim', 'nvim-ts-autotag', 'dial.nvim', 'YankAssassin.vim', 'nvim-lint', 'nvim-dap-ui', 'nvim-dap', 'prettier.nvim', 'neodim', 'undofile_warn.vim', 'vim-test', 'neogen', 'diffview.nvim', 'vim-dotenv', 'tabout.nvim', 'nvim-dap-virtual-text', 'jester', 'gitsigns.nvim', 'spelunker.vim', 'git-messenger.vim', 'spellsitter.nvim'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
