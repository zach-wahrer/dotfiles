...
vim.cmd [[au FileType go ++once lua require("packer.load")({'nvim-dap-go', 'gotests-vim', 'nvim-dap-ui', 'vim-go', 'vim-delve'}, { ft = "go" }, _G.packer_plugins)]]
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'kommentary', 'nvim-dap', 'null-ls.nvim', 'nvim-code-action-menu', 'spelunker.vim', 'spellsitter.nvim', 'lualine-lsp-progress', 'lsp_signature.nvim', 'lsp-colors.nvim', 'prettier.nvim', 'lazygit.nvim', 'nvim-ts-rainbow', 'gitsigns.nvim', 'git-messenger.vim', 'nvim-ts-autotag', 'diffview.nvim', 'dial.nvim', 'vim-test', 'vim-sandwich', 'vim-fugitive', 'YankAssassin.vim', 'vim-dotenv', 'undotree', 'registers.nvim', 'undofile_warn.vim', 'neogen', 'tabout.nvim'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
