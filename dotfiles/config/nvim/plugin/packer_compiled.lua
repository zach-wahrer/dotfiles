...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'null-ls.nvim', 'vim-dotenv', 'undofile_warn.vim', 'kommentary', 'tabout.nvim', 'jester', 'spelunker.vim', 'gitsigns.nvim', 'spellsitter.nvim', 'git-messenger.vim', 'registers.nvim', 'diffview.nvim', 'dial.nvim', 'nvim-ts-autotag', 'neogen', 'YankAssassin.vim', 'prettier.nvim', 'nvim-dap-ui', 'vim-test', 'nvim-surround', 'nvim-dap', 'nvim-dap-virtual-text', 'neodim'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
