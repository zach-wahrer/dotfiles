...
vim.cmd [[au FileType go ++once lua require("packer.load")({'vim-delve', 'gotests-nvim', 'nvim-dap-go', 'vim-go'}, { ft = "go" }, _G.packer_plugins)]]
time([[Defining lazy-load filetype autocommands]], false)
  -- Event lazy-loads
time([[Defining lazy-load event autocommands]], true)
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'vim-dotenv', 'undofile_warn.vim', 'tabout.nvim', 'spelunker.vim', 'spellsitter.nvim', 'nvim-surround', 'jester', 'registers.nvim', 'prettier.nvim', 'gitsigns.nvim', 'nvim-ts-autotag', 'git-messenger.vim', 'neodim', 'diffview.nvim', 'dial.nvim', 'kommentary', 'nvim-dap-ui', 'nvim-dap', 'vim-test', 'nvim-dap-virtual-text', 'neogen', 'null-ls.nvim', 'YankAssassin.vim'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
