...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'jester', 'neodim', 'gitsigns.nvim', 'git-messenger.vim', 'prettier.nvim', 'diffview.nvim', 'dial.nvim', 'nvim-dap-virtual-text', 'tabout.nvim', 'spelunker.vim', 'spellsitter.nvim', 'YankAssassin.vim', 'nvim-dap-ui', 'kommentary', 'nvim-dap', 'nvim-surround', 'vim-dotenv', 'null-ls.nvim', 'undofile_warn.vim', 'registers.nvim', 'neogen', 'nvim-ts-autotag', 'vim-test'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
