...
vim.cmd [[au FileType go ++once lua require("packer.load")({'gotests-vim', 'nvim-dap-ui', 'nvim-dap-go', 'vim-go', 'vim-delve'}, { ft = "go" }, _G.packer_plugins)]]
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'spellsitter.nvim', 'lazygit.nvim', 'registers.nvim', 'gitsigns.nvim', 'git-messenger.vim', 'nvim-ts-rainbow', 'diffview.nvim', 'nvim-lspconfig', 'dial.nvim', 'nvim-dap', 'YankAssassin.vim', 'null-ls.nvim', 'vim-fugitive', 'lualine-lsp-progress', 'vim-dotenv', 'undotree', 'vim-test', 'undofile_warn.vim', 'prettier.nvim', 'trouble.nvim', 'nvim-autopairs', 'vim-sandwich', 'neogen', 'lsp_signature.nvim', 'tabout.nvim', 'nvim-code-action-menu', 'spelunker.vim', 'kommentary', 'lsp-colors.nvim'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
