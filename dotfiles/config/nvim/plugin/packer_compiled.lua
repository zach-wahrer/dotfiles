...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'kommentary', 'neogen', 'neodim', 'nvim-ts-autotag', 'prettier.nvim', 'vim-test', 'vim-dotenv', 'undofile_warn.vim', 'gitsigns.nvim', 'git-messenger.vim', 'null-ls.nvim', 'diffview.nvim', 'dial.nvim', 'tabout.nvim', 'spelunker.vim', 'nvim-surround', 'registers.nvim', 'spellsitter.nvim', 'YankAssassin.vim', 'nvim-dap'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
