...
_G.packer_plugins = {
  ...
  ["dial.nvim"] = {
    config = { "\27LJ\2\n.\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\19interface.dial\frequire\0" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
  ...
  neogen = {
    config = { "\27LJ\2\n0\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\21interface.neogen\frequire\0" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
  ...
  ["vim-fugitive"] = {
    config = { "\27LJ\2\n,\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\17git.fugitive\frequire\0" },
    loaded = false,
    needs_bufread = true,
    only_cond = false,
    path = "/home/zach/.local/share/nvim/site/pack/packer/opt/vim-fugitive",
...
vim.cmd [[au FileType go ++once lua require("packer.load")({'vim-go', 'vim-delve', 'gotests-vim', 'nvim-dap-ui', 'nvim-dap-go'}, { ft = "go" }, _G.packer_plugins)]]
time([[Defining lazy-load filetype autocommands]], false)
  -- Event lazy-loads
time([[Defining lazy-load event autocommands]], true)
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'null-ls.nvim', 'nvim-autopairs', 'vim-fugitive', 'lualine-lsp-progress', 'diffview.nvim', 'kommentary', 'dial.nvim', 'lsp-colors.nvim', 'undotree', 'undofile_warn.vim', 'trouble.nvim', 'gitsigns.nvim', 'git-messenger.vim', 'vim-test', 'spelunker.vim', 'vim-sandwich', 'spellsitter.nvim', 'registers.nvim', 'nvim-ts-autotag', 'nvim-ts-rainbow', 'neogen', 'prettier.nvim', 'vim-dotenv', 'lsp_signature.nvim', 'nvim-lspconfig', 'YankAssassin.vim', 'tabout.nvim', 'nvim-dap', 'lazygit.nvim', 'nvim-code-action-menu'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
