...
vim.cmd [[au FileType go ++once lua require("packer.load")({'nvim-dap-go', 'vim-go', 'gotests-nvim', 'vim-delve'}, { ft = "go" }, _G.packer_plugins)]]
vim.cmd [[au FileType lua ++once lua require("packer.load")({'stylua-nvim'}, { ft = "lua" }, _G.packer_plugins)]]
time([[Defining lazy-load filetype autocommands]], false)
  -- Event lazy-loads
time([[Defining lazy-load event autocommands]], true)
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'nvim-lint', 'YankAssassin.vim', 'nvim-dap-ui', 'vim-test', 'nvim-dap', 'vim-dotenv', 'undofile_warn.vim', 'tabout.nvim', 'spelunker.vim', 'spellsitter.nvim', 'gitsigns.nvim', 'prettier.nvim', 'registers.nvim', 'diffview.nvim', 'neogen', 'jester', 'nvim-dap-virtual-text', 'neodim', 'dial.nvim', 'nvim-ts-autotag', 'git-messenger.vim'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
