...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'nvim-dap', 'diffview.nvim', 'dial.nvim', 'vim-test', 'null-ls.nvim', 'kommentary', 'YankAssassin.vim', 'gitsigns.nvim', 'git-messenger.vim', 'neogen', 'neodim', 'spellsitter.nvim', 'registers.nvim', 'prettier.nvim', 'nvim-ts-autotag', 'vim-dotenv', 'spelunker.vim', 'nvim-surround', 'undofile_warn.vim', 'tabout.nvim'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
