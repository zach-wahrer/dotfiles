...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'tabout.nvim', 'nvim-dap-ui', 'spelunker.vim', 'nvim-dap', 'neogen', 'gitsigns.nvim', 'git-messenger.vim', 'nvim-ts-autotag', 'spellsitter.nvim', 'diffview.nvim', 'registers.nvim', 'dial.nvim', 'prettier.nvim', 'neodim', 'kommentary', 'vim-test', 'YankAssassin.vim', 'nvim-lint', 'vim-dotenv', 'nvim-surround', 'undofile_warn.vim', 'nvim-dap-virtual-text', 'jester'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
