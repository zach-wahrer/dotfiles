...
vim.cmd [[au FileType go ++once lua require("packer.load")({'gotests-vim', 'vim-delve', 'vim-go', 'nvim-dap-go'}, { ft = "go" }, _G.packer_plugins)]]
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'vim-test', 'vim-dotenv', 'gitsigns.nvim', 'git-messenger.vim', 'undofile_warn.vim', 'diffview.nvim', 'dial.nvim', 'tabout.nvim', 'YankAssassin.vim', 'spelunker.vim', 'spellsitter.nvim', 'nvim-ts-autotag', 'registers.nvim', 'neogen', 'nvim-lint', 'prettier.nvim', 'nvim-dap-ui', 'neodim', 'jester', 'nvim-dap', 'nvim-dap-virtual-text'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
