...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'tabout.nvim', 'spelunker.vim', 'neodim', 'nvim-surround', 'gitsigns.nvim', 'spellsitter.nvim', 'git-messenger.vim', 'prettier.nvim', 'diffview.nvim', 'dial.nvim', 'kommentary', 'jester', 'vim-test', 'nvim-dap-ui', 'vim-dotenv', 'nvim-dap', 'undofile_warn.vim', 'null-ls.nvim', 'neogen', 'nvim-ts-autotag', 'YankAssassin.vim', 'registers.nvim', 'nvim-dap-virtual-text'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
