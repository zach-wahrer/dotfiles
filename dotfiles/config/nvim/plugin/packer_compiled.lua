...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'tabout.nvim', 'neodim', 'nvim-dap-virtual-text', 'spelunker.vim', 'spellsitter.nvim', 'gitsigns.nvim', 'registers.nvim', 'prettier.nvim', 'git-messenger.vim', 'dial.nvim', 'nvim-lint', 'undofile_warn.vim', 'vim-test', 'nvim-dap-ui', 'neogen', 'nvim-dap', 'vim-dotenv', 'jester', 'kommentary', 'nvim-surround', 'nvim-ts-autotag', 'diffview.nvim', 'YankAssassin.vim'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
