...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'diffview.nvim', 'dial.nvim', 'kommentary', 'vim-test', 'YankAssassin.vim', 'vim-dotenv', 'undotree', 'null-ls.nvim', 'undofile_warn.vim', 'neogen', 'lualine-lsp-progress', 'tabout.nvim', 'lsp_signature.nvim', 'lsp-colors.nvim', 'prettier.nvim', 'git-messenger.vim', 'spelunker.vim', 'spellsitter.nvim', 'registers.nvim', 'nvim-dap', 'nvim-ts-autotag', 'gitsigns.nvim'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
