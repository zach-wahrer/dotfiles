...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'nvim-dap', 'vim-dotenv', 'undofile_warn.vim', 'vim-test', 'jester', 'tabout.nvim', 'spelunker.vim', 'nvim-ts-autotag', 'spellsitter.nvim', 'nvim-dap-virtual-text', 'git-messenger.vim', 'prettier.nvim', 'nvim-surround', 'diffview.nvim', 'neodim', 'registers.nvim', 'YankAssassin.vim', 'nvim-lint', 'dial.nvim', 'neogen', 'kommentary', 'gitsigns.nvim', 'nvim-dap-ui'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
