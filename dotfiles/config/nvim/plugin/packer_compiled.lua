...
vim.cmd [[au FileType go ++once lua require("packer.load")({'gotests-nvim', 'vim-go', 'nvim-dap-go', 'vim-delve'}, { ft = "go" }, _G.packer_plugins)]]
vim.cmd [[au FileType mod ++once lua require("packer.load")({'vim-go'}, { ft = "mod" }, _G.packer_plugins)]]
time([[Defining lazy-load filetype autocommands]], false)
  -- Event lazy-loads
time([[Defining lazy-load event autocommands]], true)
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'spellsitter.nvim', 'registers.nvim', 'gitsigns.nvim', 'prettier.nvim', 'nvim-dap-virtual-text', 'vim-test', 'nvim-ts-autotag', 'diffview.nvim', 'dial.nvim', 'nvim-surround', 'nvim-lint', 'YankAssassin.vim', 'nvim-dap-ui', 'kommentary', 'nvim-dap', 'vim-dotenv', 'undofile_warn.vim', 'jester', 'tabout.nvim', 'git-messenger.vim', 'neodim', 'neogen', 'spelunker.vim'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
