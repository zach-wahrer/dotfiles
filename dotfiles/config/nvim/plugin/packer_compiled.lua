...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'neogen', 'spelunker.vim', 'spellsitter.nvim', 'registers.nvim', 'prettier.nvim', 'nvim-ts-autotag', 'jester', 'nvim-lint', 'YankAssassin.vim', 'vim-test', 'neodim', 'git-messenger.vim', 'nvim-dap-ui', 'nvim-dap', 'dial.nvim', 'undofile_warn.vim', 'tabout.nvim', 'gitsigns.nvim', 'diffview.nvim', 'nvim-dap-virtual-text'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
