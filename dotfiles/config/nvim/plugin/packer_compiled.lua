...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'vim-test', 'nvim-lint', 'vim-dotenv', 'nvim-dap', 'gitsigns.nvim', 'git-messenger.vim', 'tabout.nvim', 'diffview.nvim', 'neogen', 'spellsitter.nvim', 'registers.nvim', 'neodim', 'prettier.nvim', 'dial.nvim', 'nvim-dap-virtual-text', 'jester', 'YankAssassin.vim', 'undofile_warn.vim', 'spelunker.vim', 'nvim-ts-autotag', 'nvim-dap-ui'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
