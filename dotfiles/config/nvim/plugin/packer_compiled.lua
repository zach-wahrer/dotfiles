...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'nvim-lint', 'nvim-dap-ui', 'nvim-dap', 'undofile_warn.vim', 'jester', 'neodim', 'gitsigns.nvim', 'tabout.nvim', 'nvim-ts-autotag', 'git-messenger.vim', 'spelunker.vim', 'spellsitter.nvim', 'vim-dotenv', 'nvim-dap-virtual-text', 'diffview.nvim', 'neogen', 'YankAssassin.vim', 'dial.nvim', 'prettier.nvim', 'registers.nvim', 'vim-test'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
