...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'nvim-dap-ui', 'neodim', 'YankAssassin.vim', 'nvim-dap', 'null-ls.nvim', 'vim-dotenv', 'kommentary', 'gitsigns.nvim', 'git-messenger.vim', 'tabout.nvim', 'nvim-surround', 'spelunker.vim', 'spellsitter.nvim', 'diffview.nvim', 'dial.nvim', 'registers.nvim', 'prettier.nvim', 'nvim-ts-autotag', 'nvim-dap-virtual-text', 'neogen', 'undofile_warn.vim', 'vim-test', 'jester'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
