...
vim.cmd [[au FileType go ++once lua require("packer.load")({'vim-go', 'gotests-nvim', 'nvim-dap-go', 'vim-delve'}, { ft = "go" }, _G.packer_plugins)]]
vim.cmd [[au FileType csv ++once lua require("packer.load")({'rainbow_csv'}, { ft = "csv" }, _G.packer_plugins)]]
time([[Defining lazy-load filetype autocommands]], false)
  -- Event lazy-loads
time([[Defining lazy-load event autocommands]], true)
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'registers.nvim', 'prettier.nvim', 'nvim-dap-virtual-text', 'nvim-ts-autotag', 'gitsigns.nvim', 'git-messenger.vim', 'diffview.nvim', 'dial.nvim', 'jester', 'vim-test', 'nvim-dap-ui', 'vim-dotenv', 'nvim-dap', 'undofile_warn.vim', 'YankAssassin.vim', 'nvim-surround', 'tabout.nvim', 'kommentary', 'spelunker.vim', 'neogen', 'null-ls.nvim', 'spellsitter.nvim', 'neodim'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
