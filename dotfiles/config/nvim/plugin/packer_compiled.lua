...
vim.cmd [[au FileType go ++once lua require("packer.load")({'vim-delve', 'vim-go', 'gotests-vim', 'nvim-dap-go'}, { ft = "go" }, _G.packer_plugins)]]
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'vim-dotenv', 'git-messenger.vim', 'gitsigns.nvim', 'nvim-surround', 'nvim-dap-virtual-text', 'jester', 'null-ls.nvim', 'nvim-ts-autotag', 'neogen', 'neodim', 'nvim-dap', 'nvim-dap-ui', 'prettier.nvim', 'registers.nvim', 'spellsitter.nvim', 'YankAssassin.vim', 'spelunker.vim', 'undofile_warn.vim', 'tabout.nvim', 'kommentary', 'diffview.nvim', 'dial.nvim', 'vim-test'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
