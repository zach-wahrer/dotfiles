...
vim.cmd [[au FileType go ++once lua require("packer.load")({'nvim-dap-go', 'vim-delve', 'vim-go', 'gotests-nvim'}, { ft = "go" }, _G.packer_plugins)]]
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'null-ls.nvim', 'vim-test', 'spelunker.vim', 'nvim-dap', 'neodim', 'registers.nvim', 'nvim-dap-ui', 'spellsitter.nvim', 'nvim-dap-virtual-text', 'diffview.nvim', 'nvim-surround', 'vim-dotenv', 'git-messenger.vim', 'neogen', 'gitsigns.nvim', 'YankAssassin.vim', 'nvim-ts-autotag', 'prettier.nvim', 'undofile_warn.vim', 'tabout.nvim', 'dial.nvim', 'jester', 'kommentary'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
