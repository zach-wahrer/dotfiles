...
vim.cmd [[au FileType go ++once lua require("packer.load")({'vim-go', 'nvim-dap-go', 'vim-delve', 'gotests-vim'}, { ft = "go" }, _G.packer_plugins)]]
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'nvim-dap-virtual-text', 'nvim-dap', 'vim-dotenv', 'undofile_warn.vim', 'neodim', 'tabout.nvim', 'spelunker.vim', 'jester', 'registers.nvim', 'gitsigns.nvim', 'YankAssassin.vim', 'neogen', 'dial.nvim', 'nvim-dap-ui', 'prettier.nvim', 'spellsitter.nvim', 'nvim-ts-autotag', 'nvim-lint', 'vim-test', 'diffview.nvim', 'git-messenger.vim'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
