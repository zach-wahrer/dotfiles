...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'git-messenger.vim', 'spellsitter.nvim', 'registers.nvim', 'nvim-dap-virtual-text', 'dial.nvim', 'nvim-dap-ui', 'nvim-surround', 'nvim-dap', 'kommentary', 'vim-test', 'null-ls.nvim', 'neogen', 'nvim-ts-autotag', 'vim-dotenv', 'undofile_warn.vim', 'tabout.nvim', 'jester', 'neodim', 'diffview.nvim', 'YankAssassin.vim', 'spelunker.vim', 'gitsigns.nvim', 'prettier.nvim'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
