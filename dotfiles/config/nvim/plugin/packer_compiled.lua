...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'nvim-ts-autotag', 'nvim-dap-ui', 'nvim-dap', 'nvim-dap-virtual-text', 'dial.nvim', 'vim-dotenv', 'undofile_warn.vim', 'YankAssassin.vim', 'neodim', 'tabout.nvim', 'gitsigns.nvim', 'git-messenger.vim', 'spellsitter.nvim', 'registers.nvim', 'vim-test', 'prettier.nvim', 'nvim-surround', 'null-ls.nvim', 'diffview.nvim', 'spelunker.vim', 'kommentary', 'jester', 'neogen'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
