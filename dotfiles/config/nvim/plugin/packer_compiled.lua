...
vim.cmd [[au FileType go ++once lua require("packer.load")({'vim-delve', 'gotests-vim', 'vim-go', 'nvim-dap-go'}, { ft = "go" }, _G.packer_plugins)]]
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'null-ls.nvim', 'kommentary', 'jester', 'tabout.nvim', 'nvim-dap-virtual-text', 'spelunker.vim', 'gitsigns.nvim', 'git-messenger.vim', 'spellsitter.nvim', 'YankAssassin.vim', 'dial.nvim', 'nvim-ts-autotag', 'neogen', 'vim-test', 'neodim', 'registers.nvim', 'nvim-dap-ui', 'nvim-surround', 'undofile_warn.vim', 'nvim-dap', 'diffview.nvim', 'prettier.nvim', 'vim-dotenv'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
