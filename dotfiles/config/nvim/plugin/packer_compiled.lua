...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'tabout.nvim', 'spelunker.vim', 'git-messenger.vim', 'registers.nvim', 'prettier.nvim', 'diffview.nvim', 'dial.nvim', 'nvim-surround', 'kommentary', 'YankAssassin.vim', 'jester', 'nvim-dap-ui', 'nvim-dap', 'vim-test', 'nvim-ts-autotag', 'neodim', 'spellsitter.nvim', 'vim-dotenv', 'null-ls.nvim', 'undofile_warn.vim', 'gitsigns.nvim', 'neogen', 'nvim-dap-virtual-text'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
